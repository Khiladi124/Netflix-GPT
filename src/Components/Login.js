...
const Login = () => {
  ...
  return (<div className="bg-gray-900 min-h-screen">
    ...
    <Header /> <div className="absolute">
      <img className=" w-screen m-auto p-auto min-h-[430px]" src="https://assets.nflxext.com/ffe/siteui/vlv3/cacfadb7-c017-4318-85e4-7f46da1cae88/e43aa8b1-ea06-46a5-abe3-df13243e718d/IN-en-20240603-popsignuptwoweeks-perspective_alpha_website_large.jpg" alt="background" />
    </div>
   
    <form onSubmit={(e) => e.preventDefault()} className="absolute min-w-80 max-w-lg p-12 bg-black bg-opacity-55 w-1/3 h-auto my-20 mx-auto right-0 left-0">
